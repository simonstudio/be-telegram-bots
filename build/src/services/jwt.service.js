...
const generateAuthTokens = (user) => __awaiter(void 0, void 0, void 0, function* () {
    const accessToken = generateToken(user._id, tokens_1.tokenTypes.ACCESS);
    yield saveToken(accessToken, user._id, tokens_1.tokenTypes.ACCESS);
    return accessToken;
});
/**
...
const removeToken = (user) => __awaiter(void 0, void 0, void 0, function* () {
    let res = yield token_model_1.default.findOneAndDelete({ user: user.id });
    return res;
});
module.exports = {
    generateToken,
